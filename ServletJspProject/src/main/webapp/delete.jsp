...
<lable>Name:</lable> &nbsp&nbsp<input class=id name='name' value="<%=name %>" readonly><br><br>
<lable>Salary:</lable>&nbsp&nbsp <input class=id name='sal' value="<%= sal%>" readonly><br><br>
<lable>Email:</lable> &nbsp&nbsp<input class=id name='email' value="<%=email %>"readonly ><br><br>
